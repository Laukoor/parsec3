...
class MutexException: public std::exception {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified mutex error";}
};

//Mutex initialization error
class MutexInitException: public MutexException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while initializing mutex";}
};

//Mutex destruction error
class MutexDestroyException: public MutexException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while destroying mutex";}
};
