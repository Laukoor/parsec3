...
class RWLockException: public std::exception {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified rwlock error";}
};

//RWLock initialization error
class RWLockInitException: public RWLockException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while initializing rwlock";}
};

//RWLock destruction error
class RWLockDestroyException: public RWLockException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while destroying rwlock";}
};

//Resources exhausted
class RWLockResourceException: public RWLockException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Insufficient resources";}
};

//General locking error
class RWLockLockingException: public RWLockException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified locking error";}
};

//Deadlock detected
class RWLockDeadlockException: public RWLockLockingException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Deadlock detected";}
};

//Unknown error
class RWLockUnknownException: public RWLockException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unknown error";}
};
