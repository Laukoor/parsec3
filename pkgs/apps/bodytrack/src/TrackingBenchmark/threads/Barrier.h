...
class BarrierException: public std::exception {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified barrier error";}
};

//Barrier initialization error
class BarrierInitException: public BarrierException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while initializing barrier";}
};

//Barrier destruction error
class BarrierDestroyException: public BarrierException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified error while destroying barrier";}
};
