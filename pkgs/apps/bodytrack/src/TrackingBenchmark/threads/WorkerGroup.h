...
class WorkerGroupException: public std::exception {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Unspecified worker group exception";}
};

//General group exception
class WorkerGroupCommandException: public WorkerGroupException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Illegal command exception";}
};

//General group exception
class WorkerGroupCommandRangeException: public WorkerGroupCommandException {
  public:
    virtual const char *what() const noexcept /*throw()*/ {return "Command out of range";}
};
